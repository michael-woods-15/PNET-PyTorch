    ...
    def save_results(self):        
        ...
        with open(csv_filename, 'w', newline='') as f:
            ...
            writer.writerow([
                ...
                'gamma', 'hidden_layers', 'dropout', 'mean_val_loss', 'std_val_loss',
...
if __name__ == '__main__':
    hyperparam_evaluator = HyperparameterEvaluator(
        trials_per_config=5,
        configs_path="../experiments/hyperparameters/baseline_optuna_search_final_20260216_160724/top_10_configs.json",
