...
class HyperparameterEvaluator:
    ...
    def run_individual_trial(self, params, config_idx, trial_idx):
        ...
        trainer = ReactomeGNNTrainer(
            ...
            pathway_weight_decay = params['pathway_weight_decay'],
    ...
    def save_results(self):        
        ...
        with open(csv_filename, 'w', newline='') as f:
            ...
            writer.writerow([
                'config_number', 'learning_rate', 'weight_decay', 'pathway_weight_decay', 'step_size', 'gamma', 
                'projection_dim', 'hidden_dim', 'dropout_h0', 'dropout_h', 'mean_val_loss', 'std_val_loss',
